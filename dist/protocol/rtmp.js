...
const logger = nms_core_1.LoggerFactory.getLogger('RTMP Protocol');
...
class Rtmp {
    handshakePayload = node_buffer_1.Buffer.alloc(RTMP_HANDSHAKE_SIZE);
    handshakeState = RtmpHandshakeState.UNINIT;
    handshakeBytes = 0;
    parserBuffer = node_buffer_1.Buffer.alloc(MAX_CHUNK_HEADER);
    parserState = RtmpParserState.INIT;
    parserBytes = 0;
    parserBasicBytes = 0;
    parserPacket = null;
    inPackets = new Map();
    ...
    sendPing() {
        let rtmpBuffer = node_buffer_1.Buffer.from('020000000000060400000000000600000000', 'hex');
