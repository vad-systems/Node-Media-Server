...
const logger = nms_core_1.LoggerFactory.getLogger('FLV Protocol');
var FlvMediaType;
...
class FOURCC {
    static AV1 = node_buffer_1.Buffer.from('av01');
    static VP9 = node_buffer_1.Buffer.from('vp09');
    static HEVC = node_buffer_1.Buffer.from('hvc1');
    static AC3 = node_buffer_1.Buffer.from('ac-3');
    static EAC3 = node_buffer_1.Buffer.from('ec-3');
    static OPUS = node_buffer_1.Buffer.from('Opus');
    static MP3 = node_buffer_1.Buffer.from('.mp3');
