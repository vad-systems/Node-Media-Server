...
class NodeHttpSession extends NodeSession_js_1.NodeSession {
    constructor(config, req, res) {
        super(config, req.remoteAddress, req.nmsConnectionType === index_js_2.NodeConnectionType.WS ? 'websocket-flv' : 'http-flv');
    ...
    onStartPlay() {
        ...
        if (!(publisher instanceof NodeRtmpSession_js_1.NodeRtmpSession)) {
            return;
        }
