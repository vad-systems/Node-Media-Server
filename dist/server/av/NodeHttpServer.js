...
const index_js_1 = require("@nms/api/index.js");
const index_js_2 = require("@nms/core/index.js");
...
class NodeHttpServer {
    constructor() {
        this.logger = index_js_2.LoggerFactory.getLogger('HTTP Server');
        this.config = index_js_2.context.configProvider.getConfig();
        index_js_2.context.nodeEvent.on('configChanged', () => {
            this.config = index_js_2.context.configProvider.getConfig();
        });
    }
    isRunning() {
    ...
    initServer() {
        ...
        if (this.config.http.api !== false) {
            ...
            (0, index_js_1.setupRoutes)(app, index_js_2.context);
        }
    ...
    stop() {
        ...
        index_js_2.context.sessions.forEach((session, id) => {
